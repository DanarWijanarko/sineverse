...
interface InputProps {
	...
	showClear?: boolean;
	isLoading: boolean;
	valueTemplate: React.ReactNode | ((option: any, props: DropdownProps) => React.ReactNode);
...
const InputDropdown = ({
	...
	const passThroughOptions = {
		...
		itemgroup: {
			className: classNames("m-0 p-1 text-gray-800 bg-red font-bold", "cursor-auto"),
		},
		...
		clearIcon: {
			className: "absolute right-4 text-gray -mt-2 hover:text-white transition-all",
		},
		// transition: {
