    ...
    const passThroughOptions = {
        ...
        arrow: ({ context }: TooltipPassThroughMethodOptions) => ({
            className: classNames(
                "absolute w-0 h-0 border-green/0 border-solid",
                {
                    "-mt-2 border-y-[0.5rem] border-r-[0.5rem] border-l-0 border-r-green":
                        context.right,
                    "-mt-2 border-y-[0.5rem] border-l-[0.5rem] border-r-0 border-l-green":
                        context.left,
                    "-ml-2 border-x-[0.5rem] border-t-[0.5rem] border-b-0 border-t-green":
                        context.top,
