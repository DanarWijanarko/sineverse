import { Carousel, CarouselPassThroughMethodOptions } from "primereact/carousel";
...
const SingleCarousel = ({
	...
	const passThroughOptions = {
		...
		indicators: {
			className: "flex flex-row justify-center gap-1 flex-wrap absolute bottom-24 right-20",
		},
		indicatorbutton: ({ context }: CarouselPassThroughMethodOptions) => ({
			className: classNames("w-4 h-1 transition duration-200 rounded-full hover:bg-white", {
	...
	if (isLoading)
		return (
			<div className="relative h-[800px] w-full">
				<span className="absolute bottom-0 left-0 z-10 h-1/3 w-full bg-gradient-to-t from-black-800 to-black-800/0" />
